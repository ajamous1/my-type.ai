...
export default function BentoGrid(): ReactElement {
  ...
  // Regular bento card component with title precisely centered vertically with thumbnail
  const BentoCard = ({ title, description, size = 'default' }: BentoCardProps): ReactElement => (
